...
class Interface:
    ...
    def __init__(self, master):
        ...
        self.my_button = Button(master, text="Click here to submit your text.", command=lambda:[self.evaluate_the_text(),
                                                                                                self.end_countdown()])
        self.my_button.grid(row=3, column=2)
        ...
        self.heading_label.config(text="Ready to type?", font=("arial", 30, "bold"), fg="Green", bg="Yellow")
        ...
        self.selected_text = TextMachine().choose_text()
    ...
    def end_countdown(self):
        ...
        self.result_text = f"You typed this text in {self.time_lapsed} seconds. You typed {config.number_of_words_typed} words." \
